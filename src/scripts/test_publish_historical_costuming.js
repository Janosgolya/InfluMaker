...
async function publishHistoricalCostuming() {
    console.log('======================================================');
    console.log('🤖 REDDIT: PUBLISHING LIVE POST TO r/HistoricalCostuming');
    console.log('======================================================\n');
    ...
    try {
        console.log('🌐 Opening Reddit home to warm cookies...');
        ...
        // 4. Submit First Comment if on live comments page
        ...
        // 5. Navigate to Betty's profile to verify live post history
...
publishHistoricalCostuming().then(r => console.log('Final Result:', r));
